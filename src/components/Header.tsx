      ...
      <header
        className={
          y > 0 && !["/services", "/news"].includes(location.pathname)
            ? "backdrop-invert bg-white/30 backdrop-opacity-10 fixed top-0 left-0 right-0 z-50"
            : "bg-white"
        }
      >
        <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
          <Link
            ...
            to={
              ["/home/admin"].includes(location.pathname) ? "/home/admin" : "/"
            }
          >
          ...
          <div className="flex flex-1 items-center justify-end md:justify-between">
            ...
            <div className="flex items-center gap-4">
              {["/home/admin"].includes(location.pathname) ? (
